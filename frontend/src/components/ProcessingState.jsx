const STEPS = [
  ...
  { label: "Detecting subject", threshold: 40 },
  { label: "Removing background", threshold: 70 },
  { label: "Generating PNG", threshold: 90 },
    ...
    <div className="fade-up flex flex-col items-center text-center max-w-sm w-full">
      <div className="relative w-24 h-24 mb-8">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <svg className="spinner" width="22" height="22" viewBox="0 0 24 24"
      ...
      <div className="w-full h-1.5 rounded-full overflow-hidden relative"
        ...
        <div className="h-full rounded-full shimmer relative overflow-hidden transition-all duration-500"
